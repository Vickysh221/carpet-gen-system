...
PROTOTYPE_ENTRY_SOURCE: list[PrototypeRetrievalEntry] = [
    ...
    PrototypeRetrievalEntry(
        entry_id="coffee-time-main",
        prototype_id="coffee-time",
        label="咖啡时光",
        route_type="prototype-first",
        field="colorMood",
        reading_ids=["coffee-time-ritual"],
        aliases=["咖啡时光"],
        semantic_summary="偏暖、低刺激、日常放松、仪式感但不重。",
        slot_summary="主指向 color，次指向 impression calm/softness。",
        rationale="比单纯咖啡更偏日常仪式感和轻陪伴感的生活方式原型。",
        embedding_text="咖啡时光 日常放松 轻陪伴感 仪式感但不重 低刺激 偏暖 安静日常",
        explain_text="prototype-first；偏暖、低刺激、带日常仪式感的咖啡时光原型。",
    ),
    PrototypeRetrievalEntry(
        entry_id="quiet-daily-main",
        prototype_id="quiet-daily",
        label="安静日常感",
        route_type="prototype-first",
        field="overallImpression",
        reading_ids=["quiet-daily-main"],
        aliases=["安静日常感"],
        semantic_summary="低刺激、安静、自然陪伴、不过度表现。",
        slot_summary="主指向 impression，次指向 motif restraint。",
        rationale="偏低刺激、稳定、日常可久处的生活方式原型。",
        embedding_text="安静日常感 低刺激 日常感 安静 陪伴感 不过度表现 稳定 松弛",
        explain_text="prototype-first；主看 impression calm/softness，次看整体视觉 restraint。",
    ),
    PrototypeRetrievalEntry(
        entry_id="light-companionship-main",
        prototype_id="light-companionship",
        label="轻陪伴感",
        route_type="prototype-first",
        field="overallImpression",
        reading_ids=["light-companionship-main"],
        aliases=["轻陪伴感"],
        semantic_summary="轻柔、陪伴、不过度占据注意力。",
        slot_summary="主指向 impression softness，次指向 color warmth。",
        rationale="比温暖更轻、比陪伴感更克制的细弱日常氛围原型。",
        embedding_text="轻陪伴感 轻柔 陪伴 温和 不抢 低刺激 温暖一点 轻轻陪着",
        explain_text="prototype-first；主看 impression softness，次看 warmth。",
    ),
    PrototypeRetrievalEntry(
        entry_id="subtle-presence-main",
        prototype_id="subtle-presence",
        label="若有若无",
        route_type="prototype-first",
        field="colorMood",
        reading_ids=["subtle-presence-color"],
        aliases=["草色遥看近却无", "若有若无", "轻存在感"],
        semantic_summary="轻微存在、低对比、不是空白、也不是明确抢眼。",
        slot_summary="主指向 color saturation，次指向 impression energy。",
        rationale="强调近乎不可见但并非缺席的 subtle presence 原型。",
        embedding_text="草色遥看近却无 若有若无 轻存在感 轻微存在 低对比 近乎不可见 雾感 朦胧 雾里有色",
        explain_text="prototype-first；更适合作为 subtle presence 的弱到中强证据，不应直接主导 narrative。",
    ),
]
