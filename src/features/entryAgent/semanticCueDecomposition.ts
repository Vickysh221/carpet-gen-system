...
const CUE_RULES: CueRule[] = [
  {
    ...
    informationGainHint: "用户回答后，可减少这层绿意是需要作为明确颜色 identity 被看见，还是只作为春天气息留在整体氛围里的不确定性。",
  ...
  },
  {
    ...
    disambiguationAxes: ["color.saturation", "impression.energy"],
    informationGainHint: "用户回答后，可减少“绿意”更像要被看见的颜色方向，还是只是想保留一点春天气息的不确定性。",
    targetField: "colorMood",
    targetSlot: "color",
    confidence: 0.76,
    weight: 0.68,
  },
  {
    ...
    questionKindHint: "clarify",
    disambiguationAxes: ["color.saturation", "impression.energy"],
    informationGainHint: "用户回答后，可减少“春意”是在说颜色本身，还是主要在说整体明亮鲜活气息的不确定性。",
    targetField: "colorMood",
    targetSlot: "color",
    confidence: 0.72,
    weight: 0.62,
  },
  {
    ...
    questionKindHint: "clarify",
    disambiguationAxes: ["color.saturation", "impression.energy"],
    informationGainHint: "用户回答后，可减少“春天”更偏颜色 freshness，还是更偏整体鲜活开阔印象的不确定性。",
    targetField: "colorMood",
    targetSlot: "color",
    confidence: 0.7,
    weight: 0.58,
  },
  {
    ...
    disambiguationAxes: ["color.saturation", "impression.energy"],
    informationGainHint: "用户回答后，可减少“明媚”是在要更可见的亮度和鲜活感，还是只是不要太闷的不确定性。",
    targetField: "colorMood",
    targetSlot: "color",
    confidence: 0.76,
    weight: 0.7,
  },
  {
    ...
    questionKindHint: "contrast",
    disambiguationAxes: ["color.saturation", "impression.energy"],
    informationGainHint: "用户回答后，可减少用户说的“鲜艳”是想让颜色明确可见，还是只要整体更明亮鲜活的不确定性。",
    targetField: "colorMood",
    targetSlot: "color",
    confidence: 0.78,
    weight: 0.72,
